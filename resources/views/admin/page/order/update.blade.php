...
@section('content')
    ...
    <div class="row">
    <div class="col-12">
        <form method="POST" action="{{route('admin.order.postUpdate', $orders_orderDetails_prods->id_order)}}" enctype="multipart/form-data">
            @csrf
            <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="shipping_name" name="shipping_name"
                                        placeholder="Tên người nhận" value="{{$orders_orderDetails_prods->name_cus}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="shipping_phone"
                                        name="shipping_phone"
                                        placeholder="SĐT người nhận" value="{{$orders_orderDetails_prods->phone_cus}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="shipping_email"
                                        name="shipping_email"
                                        placeholder="Email người nhận" value="{{$orders_orderDetails_prods->email_cus}}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="shipping_address"
                                        ...
                                        placeholder="Địa chỉ người nhận" value="{{$orders_orderDetails_prods->addr_cus}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control" id="note" rows="5" name="note">{{$orders_orderDetails_prods->note_cus}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <select class="form-control product-select" name="products[0][product_id]">
                                            ...
                                            @foreach($products as $product)
                                                <option value="{{ $product->id }}" data-price="{{ $product->price }}"
                                                    @if ($orders_orderDetails_prods->id_prod == $product->id) selected @endif
                                                >
                                                    {{ $product->name }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control quantity-input"
                                            name="products[0][quantity]" value="{{$orders_orderDetails_prods->quantity}}" min="1">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
